...
/info - Подробное описание бота
/help - Получить список команд
/get_queues - Получить полный список очередей
/create_queue - Создать очередь
/create_category - Создать категорию (Только для админов)
/delete_category - Удалить категорию (Только для админов)
/cancel - Отменить команду во время её исполнения
